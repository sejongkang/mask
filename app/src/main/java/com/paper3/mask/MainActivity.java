...
public class MainActivity extends AppCompatActivity implements NaverMap.OnMapClickListener, Overlay.OnClickListener, OnMapReadyCallback, NaverMap.OnCameraChangeListener, NaverMap.OnCameraIdleListener {
    private static final int ACCESS_PERMISSION_REQUEST_CODE = 100;
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        locationSource = new FusedLocationSource(this, ACCESS_PERMISSION_REQUEST_CODE);
        ...
        infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                if("planty".equalsIgnoreCase(store.remain_stat)){
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch(requestCode){
            case ACCESS_PERMISSION_REQUEST_CODE:
    ...
    private void fetchStoreSale(double lat, double lng, int m)
    {
        ...
        maskApi.getStoreByGeo(lat, lng, m).enqueue(new Callback<StoreSaleResult>() {
            @Override
